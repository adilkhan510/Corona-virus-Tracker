...
User stories :
  1. User arrives at the page, they see dummy data, and a button that opens up a menu that shows the countries that are available to select from. In this case its about 199 countries.
